...
The application is online at [GitHub](https://github.com/WaleedHamza/ScaleUp). It is also available online [@ Heroku](https://sleepy-river-20789.herokuapp.com/). You will more than likely have to wait a little while after visiting this url before Heroku spins up the virtual machine which hosts the project.
...
In the project's root directory:
  Install the database from the command line by  entering:
